...
#define STRING_CONFIG_H_AUTHOR "kosteklvp" // Who made the changes.
...
#define CUSTOM_MACHINE_NAME "Ender-5 new v2"
 ...
 *     O-- FRONT --+
 */
#define NOZZLE_TO_PROBE_OFFSET { -53.5, 8, 0 }
...
#define XY_PROBE_FEEDRATE (X_Y_SPEED)

// Feedrate (mm/min) for the first approach when double-probing (MULTIPLE_PROBING == 2)
#define Z_PROBE_FEEDRATE_FAST (Z_SPEED)

// Feedrate (mm/min) for the "accurate" probe of each point
#define Z_PROBE_FEEDRATE_SLOW (Z_SPEED / 6)
...
#define HOMING_FEEDRATE_MM_M { (X_Y_SPEED), (X_Y_SPEED), (Z_SPEED) }
